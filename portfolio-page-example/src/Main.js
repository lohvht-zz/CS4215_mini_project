...
var author$project$Main$FixNav = {$: 'FixNav'};
var author$project$Main$IntroJumbo = {$: 'IntroJumbo'};
var author$project$Main$NavMsg = function (a) {
	return {$: 'NavMsg', a: a};
};
var author$project$Main$Abilities = {$: 'Abilities'};
var author$project$Main$Contact = {$: 'Contact'};
var author$project$Main$Experience = {$: 'Experience'};
...
var author$project$Main$routeParser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Main$IntroJumbo, elm$url$Url$Parser$top),
			A2(
			...
			elm$url$Url$Parser$s('experience')),
			A2(
			elm$url$Url$Parser$map,
...
var author$project$Main$getSectionId = function (pagesection) {
	if (pagesection.$ === 'Just') {
		var section = pagesection.a;
		switch (section.$) {
			case 'IntroJumbo':
				return 'top-jumbo';
			case 'Profile':
...
var author$project$Main$scrollToTopId = _Platform_outgoingPort('scrollToTopId', elm$json$Json$Encode$string);
	...
	function (url, model) {
		...
		if (_n0.$ === 'Nothing') {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{pageSection: author$project$Main$IntroJumbo}),
				elm$core$Platform$Cmd$none);
		} else {
			var route = _n0.a;
			var sectionId = author$project$Main$getSectionId(
			...
			return _Utils_Tuple2(
				...
				elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							author$project$Main$scrollToTopId(sectionId)
						])));
		}
	});
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		...
		var _n1 = A2(
			...
			url,
			{isNavFixed: author$project$Main$FixNav, modalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$hidden, navKey: key, navState: navState, pageSection: author$project$Main$IntroJumbo});
		var model = _n1.a;
		var urlCmd = _n1.b;
		return _Utils_Tuple2(
			model,
...
var author$project$Main$scrollNavData = _Platform_incomingPort('scrollNavData', elm$json$Json$Decode$bool);
...
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Main$scrollNavData(author$project$Main$OnScroll),
				A2(rundis$elm_bootstrap$Bootstrap$Navbar$subscriptions, model.navState, author$project$Main$NavMsg)
			]));
};
var author$project$Main$FreeNav = {$: 'FreeNav'};
			...
			case 'OnScroll':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							isNavFixed: navFixed ? author$project$Main$FixNav : author$project$Main$FreeNav
						}),
					elm$core$Platform$Cmd$none);
			case 'UrlChange':
				var url = msg.a;
...
var author$project$Main$CloseContactModal = {$: 'CloseContactModal'};
...
var author$project$Main$contactModal = function (model) {
	return A2(
		...
		A3(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text('Interested in working together? Fill out the form below with some info about yourself and I will get back to you as soon as I can!')
						])),
					A2(
					elm$html$Html$form,
					_List_fromArray(
						[
							elm$html$Html$Attributes$id('contactForm'),
							elm$html$Html$Attributes$method('post'),
							elm$html$Html$Attributes$action('https://httpbin.org/post')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$for('email-address'),
											elm$html$Html$Attributes$class('col-form-label')
										]),
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('form-control'),
											elm$html$Html$Attributes$id('email-address'),
											elm$html$Html$Attributes$name('emailAddress'),
											elm$html$Html$Attributes$minlength(1),
											elm$html$Html$Attributes$maxlength(255),
							...
							_List_fromArray(
								[
									elm$html$Html$text('Indicates required fields')
								])),
							A2(
							elm$html$Html$div,
							_List_fromArray(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$Events$onClick(author$project$Main$CloseContactModal)
												]))
										]),
									_List_fromArray(
										[
			...
			A3(
				...
				rundis$elm_bootstrap$Bootstrap$Modal$config(author$project$Main$CloseContactModal))));
};
...
var author$project$Main$navMenu = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$id('navigation-bar'),
					elm$html$Html$Attributes$classList(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'fixed',
							_Utils_eq(model.isNavFixed, author$project$Main$FixNav))
						]))
				]),
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$href('#experience')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$href('#abilities')
							]),
						_List_fromArray(
							[
...
var author$project$Main$similarSectionHeader = F2(
	function (headerTitle, headerBody) {
		return A2(
			elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
...
var author$project$Main$sectionAbilities = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_fromArray(
			[
				elm$html$Html$Attributes$id(
				author$project$Main$getSectionId(
					elm$core$Maybe$Just(author$project$Main$Abilities)))
			]),
		_List_fromArray(
			[
				A2(
				author$project$Main$similarSectionHeader,
				'Abilities',
				_List_fromArray(
					[
						elm$html$Html$text('“Wisdom is not a product of schooling but of the lifelong attempt\n       to acquire it.”'),
						A2(elm$html$Html$br, _List_Nil, _List_Nil),
						elm$html$Html$text('- Albert Einstein')
					])),
				A2(
				elm$html$Html$h3,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Technical Skills')
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('no-bullets')
									]),
								_List_fromArray(
									[
										A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('Cloud Services / API integerations')
									])),
								A2(
								elm$html$Html$ul,
								_List_fromArray(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Stripe PHP SDK')
											])),
										A2(
										elm$html$Html$li,
										_List_Nil,
										_List_fromArray(
											[
												elm$html$Html$text('Basic AWS Management')
											]))
									]))
							]))
					])),
				...
				_List_fromArray(
					[
						elm$html$Html$text('Language Proficiencies')
					])),
				A2(
				rundis$elm_bootstrap$Bootstrap$Grid$row,
				_List_Nil,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														elm$html$Html$Attributes$class('ability-title')
													]),
												_List_fromArray(
													[
														A2(
														...
														_List_fromArray(
															[
																elm$html$Html$text('English (Native)')
															]))
													])),
												A2(
												elm$html$Html$span,
												_List_fromArray(
													[
														elm$html$Html$Attributes$class('ability-score')
													]),
												_List_fromArray(
													[
														elm$html$Html$text('Fluent')
													]))
											])),
										A2(
										elm$html$Html$li,
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																elm$html$Html$text('Mandarin (Mother Tongue)')
															]))
													])),
												A2(
												elm$html$Html$span,
...
var author$project$Main$ShowContactModal = {$: 'ShowContactModal'};
var elm$html$Html$Attributes$target = elm$html$Html$Attributes$stringProperty('target');
var author$project$Main$sectionContact = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('background-gray')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id(
						author$project$Main$getSectionId(
							elm$core$Maybe$Just(author$project$Main$Contact)))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$text('Want to know more about me?')
							])),
						A2(
						rundis$elm_bootstrap$Bootstrap$Grid$row,
						_List_Nil,
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																elm$html$Html$Attributes$href('https://github.com/lohvht'),
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		elm$html$Html$text('See more of my projects!')
																	]))
															]))
													])),
												A2(
													...
													[
														...
														_List_fromArray(
															[
																...
																elm$html$Html$Events$onClick(author$project$Main$ShowContactModal)
															]),
														_List_fromArray(
															[
																A2(
																...
																_List_fromArray(
																	[
																		elm$html$Html$Attributes$class('far fa-envelope-open')
																	]),
																_List_Nil),
																A2(
																elm$html$Html$span,
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																elm$html$Html$Attributes$href('mailto:vic94loh@hotmail.com'),
																elm$html$Html$Attributes$target('_blank')
															]),
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		elm$html$Html$text('Or send me an email!')
																	]))
															]))
													]))
											]))
...
var author$project$Main$experienceSubsectionRow = F4(
	function (institutionName, yearsPresent, titleName, description) {
		return A2(
			rundis$elm_bootstrap$Bootstrap$Grid$row,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('experience-subsection')
						]))
				]),
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text(institutionName)
								])),
							A2(
							elm$html$Html$p,
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('experience-period')
								]),
							_List_fromArray(
								[
									elm$html$Html$text(yearsPresent)
								]))
						])),
					A2(
					rundis$elm_bootstrap$Bootstrap$Grid$col,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$text(titleName)
										])),
									A2(
									elm$html$Html$span,
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('hidden-phone')
										]),
									_List_fromArray(
										[
...
var author$project$Main$sectionExperience = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_fromArray(
			[
				elm$html$Html$Attributes$id(
				author$project$Main$getSectionId(
					elm$core$Maybe$Just(author$project$Main$Experience)))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text('“The purpose of life is to live it, to taste experience to the utmost, to reach out eagerly and without fear for newer and richer experience.”'),
						A2(elm$html$Html$br, _List_Nil, _List_Nil),
						elm$html$Html$text('- Eleanor Roosevelt')
					])),
				A2(
				elm$html$Html$h3,
				_List_Nil,
				...
				A4(author$project$Main$experienceSubsectionRow, 'National University of Singapore', 'Aug 2015 - Present', 'Bachelor of Computing (Honours) in Computer Science', 'Here I studied and learnt a wide range and depth of computer science\n      knowledge from basic programming, OS and networking principles\n      among others. It is in this course that got me really interested in\n      Software Engineering principles and how to architect and structure code\n      to improve maintainability.'),
				A4(author$project$Main$experienceSubsectionRow, 'NUS Overseas Colleges In Silicon Valley', 'Jan 2017 - Dec 2017', 'Overseas internship and entrepreneurship course programme', 'Year long programme overseas hosted by NUS enterprise to promote\n      entrepreneurship. Here I got a taste of working life inside a startup\n      company as well as knowledge on how businesses and startups work\n      within the Silicon Valley business ecosystem.'),
				A4(author$project$Main$experienceSubsectionRow, 'St. Andrew\'s Junior College', 'Jan 2011 - Dec 2012', 'Junior College (GCE A Levels)', 'Went to junior college where I studied Physics, Mathematics, Chemistry\n      and Economics. Realised during my last year in junior college that\n      I was interested in both technology and mathematics, thus I\n      started learning about algorithms by myself.'),
				A2(elm$html$Html$hr, _List_Nil, _List_Nil),
				A2(
				elm$html$Html$h3,
				_List_Nil,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				elm$html$Html$Attributes$id(
				author$project$Main$getSectionId(
					elm$core$Maybe$Just(author$project$Main$IntroJumbo)))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Hey There, My name is Bill')
							])),
						A2(
						elm$html$Html$p,
						_List_fromArray(
						...
						_List_fromArray(
							[
								elm$html$Html$text('Click On The Arrow To Learn More About Me!')
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$href('#profile'),
						elm$html$Html$Attributes$class('scroll-down'),
						elm$html$Html$Attributes$id('scroll-down-button')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('fa fa-chevron-down')
							]),
						_List_Nil)
					]))
			]));
};
var author$project$Main$profileDetails = F2(
...
var author$project$Main$sectionProfile = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('background-white')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id(
						author$project$Main$getSectionId(
							elm$core$Maybe$Just(author$project$Main$Profile)))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$text('I am a passionate fullstack developer')
							])),
						A2(
						rundis$elm_bootstrap$Bootstrap$Grid$row,
						_List_Nil,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('I am a web developer a burning passion for architecture and clean code.')
											]))
									])),
								A2(
								rundis$elm_bootstrap$Bootstrap$Grid$col,
									...
									[
										...
										_List_fromArray(
											[
												...
												elm$html$Html$Attributes$src('images/profile_picture.jpg'),
												elm$html$Html$Attributes$alt('Bill Chang'),
								...
								_List_fromArray(
									[
										...
										elm$core$List$concat(
											_List_fromArray(
												[
													A2(author$project$Main$profileDetails, 'Name:', 'Bill Chang'),
													_List_fromArray(
													[
														A2(elm$html$Html$br, _List_Nil, _List_Nil)
													]),
													A2(author$project$Main$profileDetails, 'Age:', '24'),
													_List_fromArray(
													[
														A2(elm$html$Html$br, _List_Nil, _List_Nil)
													]),
													A2(author$project$Main$profileDetails, 'Interests:', 'Taking long walks on the beach'),
													_List_fromArray(
													[
														A2(elm$html$Html$br, _List_Nil, _List_Nil)
													]),
													A2(author$project$Main$profileDetails, 'Location:', 'Singapore')
												])))
									]))
							]))
					]))
...
var author$project$Main$projectPreviewLink = F6(
	function (title, previewImgLink, previewAltText, linkToProject, caption, tags) {
		return A2(
			elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('effect')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									elm$html$Html$Attributes$src(previewImgLink),
									elm$html$Html$Attributes$alt(previewAltText)
								]),
							_List_Nil),
							A2(
							...
							_List_fromArray(
								[
									A2(elm$html$Html$h3, _List_Nil, title),
									A2(elm$html$Html$p, _List_Nil, caption),
									A2(
									elm$html$Html$p,
									_List_Nil,
									_List_fromArray(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href(linkToProject),
									elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('fa fa-external-link-alt')
										]),
									_List_Nil)
								]))
						]))
...
var author$project$Main$sectionProjects = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id(
						author$project$Main$getSectionId(
							elm$core$Maybe$Just(author$project$Main$Projects)))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$text('“Others have seen what is and asked why. I have seen what could be and asked why not.”'),
								A2(elm$html$Html$br, _List_Nil, _List_Nil),
								elm$html$Html$text('- Pablo Picasso')
							])),
						A6(
						author$project$Main$projectPreviewLink,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Maru, a 2D Platformer inspired by Mario and Super Meatball')
							]),
						_List_fromArray(
							['Unity', 'C#'])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Jimple')
											]))
									])),
								elm$html$Html$text(' Planner')
							]),
						...
						_List_fromArray(
							[
								elm$html$Html$text('Minimal text based task tracker, built with the working man,'),
								A2(
								elm$html$Html$i,
								_List_Nil,
								_List_fromArray(
									[
										elm$html$Html$text('Jim')
									])),
								elm$html$Html$text(' in mind')
							]),
						_List_fromArray(
							['Java']))
					]))
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(elm$html$Html$Attributes$attribute, 'data-spy', 'scroll'),
						A2(elm$html$Html$Attributes$attribute, 'data-target', '#navigation-bar'),
						A2(elm$html$Html$Attributes$attribute, 'data-offset', '0')
					]),
				_List_fromArray(
					[
						author$project$Main$navMenu(model),
						author$project$Main$sectionJumbo(model),
						author$project$Main$sectionProfile(model),
						author$project$Main$sectionExperience(model),
						author$project$Main$sectionProjects(model),
						author$project$Main$sectionAbilities(model),
						author$project$Main$sectionContact(model),
						author$project$Main$contactModal(model)
					]))
			]),
