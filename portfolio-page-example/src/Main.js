...
var author$project$Main$init = F3(
	function (flags, url, key) {
		...
		var _n1 = A2(
			...
			url,
			{modalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$hidden, navKey: key, navState: navState, pageSection: author$project$Main$IntroJumbo});
		var model = _n1.a;
		var urlCmd = _n1.b;
		return _Utils_Tuple2(
			model,
...
var author$project$Main$sectionAbilities = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$id('abilities')
			]),
		_List_fromArray(
			[
				A2(
													...
													[
														...
														_List_fromArray(
															[
																...
																A2(elm$html$Html$Attributes$attribute, 'data-target', '#contactFormModal')
															]),
														_List_fromArray(
															[
																A2(
...
var author$project$Main$sectionExperience = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$id('experience')
			]),
		_List_fromArray(
			[
				A2(
